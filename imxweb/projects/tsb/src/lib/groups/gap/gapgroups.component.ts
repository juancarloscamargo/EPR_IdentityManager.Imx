...
import { AccountSidesheetData, GAPAccountSidesheetData, GetAccountsOptionalParameters, GAPLicenciasEprinsa } from '../../accounts/accounts.models'; 
import { AccountsService } from '../../accounts/accounts.service';

import { PortalTargetsystemGapuser, PortalTargetsystemGappasku } from 'imx-api-gap';
import { GapgroupsSidesheetComponent } from './gapgroups-sidesheet/gapgroups-sidesheet.component';
...
@Component({
  ...
  selector: 'imx-data-explorer-gapgroups',
  templateUrl: './gapgroups.component.html',
  styleUrls: ['./gapgroups.component.scss']
})
export class DataExplorerGapgroupsComponent implements OnInit, OnDestroy, SideNavigationComponent {
  ...
  this.dataModel = await this.accountsService.getGAPGroupDataModel();
...
//    const data_int= await this.accountsService.getGAPAccountInteractive(data.selectedGAPAccount.GetEntity().GetColumn("UID_GAPUser").GetValue())[0];
    ...
    const sidesheetRef = this.sideSheet.open(GapgroupsSidesheetComponent, {
